# Generated by Django 3.1.1 on 2022-01-17 19:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.flsauthor')),
            ],
        ),
        migrations.CreateModel(
            name='flsGenre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='catalog.flsbook')),
            ],
            options={
                'ordering': ['due_back'],
            },
        ...
        migrations.AddField(
            model_name='flsbook',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='catalog.flsGenre'),
        ),
    ]
